  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute left-0 top-0 h-1/3 w-px bg-gradient-to-b from-transparent via-foreground to-transparent animate-pulse"></div>
        <div className="absolute left-0 bottom-0 h-1/3 w-px bg-gradient-to-t from-transparent via-foreground to-transparent animate-pulse"></div>
        <div className="absolute right-0 top-0 h-1/3 w-px bg-gradient-to-b from-transparent via-foreground to-transparent animate-pulse"></div>
        <div className="absolute right-0 bottom-0 h-1/3 w-px bg-gradient-to-t from-transparent via-foreground to-transparent animate-pulse"></div>
      </div>

      <div className="relative z-10 container mx-auto p-4 mb-8 ">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative py-6 px-8 bg-background backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div>
                  <h1 className="text-3xl sm:text-5xl font-bold text-foreground bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground to-foreground animate-text-shimmer">
                    THE NEXUS
                  </h1>
                  <p className="text-foreground mt-2 font-mono tracking-wider text-xs sm:text-base">SURVIVOR INTERFACE v1.0</p>
                </div>
                <div className="font-mono text-right">
                  <div className="text-foreground/60 text-xs sm:text-sm">SYSTEM TIME</div>
                  <div className="text-foreground tabular-nums text-sm sm:text-base">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-background/40 backdrop-blur-sm  border border-content-3 p-6 h-full">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-accent-3 font-mono text-xs sm:text-sm">SURVIVOR STATUS</h2>
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-accent-3 animate-pulse"></div>
                    <span className="text-accent-3 font-mono text-xs sm:text-sm">CONNECTED</span>
                  </div>
                </div>
                <div className="text-2xl sm:text-4xl font-bold text-accent-4 font-mono mb-4 tracking-wider">
