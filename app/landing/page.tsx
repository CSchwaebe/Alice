      ...
      <div className="w-full relative aspect-[9/16]">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-50 flex items-end justify-center">
          <motion.div
            ...
            className="text-center relative w-full max-w-md h-16 md:h-24 xl:h-32 2xl:h-40 pb-2 md:pb-8 xl:pb-16 2xl:pb-32 flex items-center justify-center"
          >
            <Link href="/" className="block group w-full h-full">
              <div className="relative transform transition-transform duration-300 group-hover:scale-105 h-full flex items-center justify-center">
                ...
                <div className="relative py-4 md:py-6 xl:py-12 2xl:py-32 px-4">
                  <h2 className={`text-2xl md:text-4xl xl:text-5xl 2xl:text-7xl font-bold text-foreground bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground to-foreground animate-text-shimmer ${iceland.className}`}>
                    Enter Game
                  </h2>
                </div>
